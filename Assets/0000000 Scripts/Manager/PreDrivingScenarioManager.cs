...
public class PreDrivingScenarioManager : MonoBehaviour
{
    ...
    private IEnumerator RoutineExperiment()
    {
        ...
        yield return StartCoroutine(RoutineByBrakePatternTypes(BrakeLightType.기본제동등A));
    ...
    { 
        ...
        Debug.Log($"시나리오 호출 : {level}, {brakeLightType}, {accelerationAndDistance.Item1}m/s^2으로 감속");
